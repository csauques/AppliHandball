...
public class RealTimeController {
    ...
    private void initialize() {
    	...
    	ter.setOnDragOver(dragEvent -> { 
    	    ...
    	    if (dragEvent.getGestureSource() != ter) { 
    	        // Indique les modes de transfert autorisÈs sur cette destination. 
    	...
    	cir.setOnDragDone(dragEvent -> { 
    	    ...
    	    if (dragEvent.getTransferMode() == TransferMode.MOVE) { 
    	        // Faire ce qui est nÈcessaire pour retirer la source ou la donnÈe.
    ...
    public void setMainApp() {
    	...
    	//r√©cupration des joueurs rempla√ßant et stockage
